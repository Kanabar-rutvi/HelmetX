...
const ScanLogSchema = new mongoose_1.Schema({
    helmetId: { type: String, required: true },
    workerId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'User' },
...
exports.default = mongoose_1.default.model('ScanLog', ScanLogSchema);
